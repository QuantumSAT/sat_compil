...
#ifndef _SIS_LSORT_H_
#define _SIS_LSORT_H_
...
DECL_SORT TYPE *
#ifdef FIELD
SORT(TYPE* list_in, int (*compare)(FIELD_TYPE, FIELD_TYPE), int cnt)
#else
SORT(TYPE* list_in, int (*compare)(TYPE*, TYPE*), int cnt)
#endif
{
...
DECL_SORT1 TYPE *
SORT1(TYPE* list_in, int (*compare)(TYPE*, TYPE*))
{
    register int cnt;
    register TYPE *p;
